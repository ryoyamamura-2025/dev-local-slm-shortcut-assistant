        ...
        messages=[
            {
                ...
                "content": (
                    ...
                    "M365 CopilotやCopilotへメッセージを送る依頼は"
                    "copilot_chatを選んでください。"
                    "messageには送信するメッセージをそのまま指定し、"
                    "modelにはOpus、Think Deeper、Quick Response、自動の"
                    "いずれかを指定してください（指定がなければOpusを使用）。"
                    "クリップボードの内容をCopilotに送る依頼では"
                    "get_clipboard_text、copilot_chatの順に選び、"
                    "copilot_chatのmessageは空のままにしてください。"
